...
background = [
              ...
              [(2400,1200), (1800, 600), (['map_4'], 30)], [(2400,1800), (1800, 1800), (['map_5'], 30)],
...
coll_boxes = [
              ...
              [(3769,867), (351,127), 'p'], [(3630,1117), (257,125), 'p'], [(2907,1628), (2067,1976), 'p'], [(3565,642), (59,771), 'p'],
              [(3590,1300), (15,771), 'p'], [(2986,1300), (15,771), 'p'], [(2403,1200), (82,3198), 'p'], [(2568,1997), (258,44), 'p'],
              [(2818,2231), (85,41), 'p'], [(2492,2231), (85,41), 'p'], [(2656,2043), (42,1643), 'p'], [(2698,2584), (129,41), 'p'],
              [(2775,2704), (129,41), 'p'], [(2700,2827), (129,41), 'p'], [(2682,2400), (254,6), 'p'], [(2483,3223), (90,41), 'p'],
              [(2569,3400), (90,41), 'p'], [(2659,3686), (1080,43), 'p'], [(2827,4066), (1422,144), 'p'], [(2483,4025), (348,172), 'p'],
              [(3790,4022), (1058,178), 'p'], [(4030,3515), (815,330), 'p'], [(3005,3515), (10,1000), 'p'], [(2465,1808), (464,12), 'p'],
              [(4848,4157), (550,42), 'p'], [(5359,3760), (44,435), 'p'], [(4224,3842), (16,213), 'p'], [(4821,3847), (24,193), 'p']
              ]
...
transition_boxes = [
                    ...
                    [(2990, 3623), 546,'right'], [(4184, 3803), 430,'right'], [(4784, 3803), 430,'right']
                    ]
